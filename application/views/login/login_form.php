...
<body class="animsition tukangna">
	...
	?>
			...
			<input type="password" name="password" size="20" class="au-input au-input--full" value="<?php echo set_value('password');?>">
                                ...
                                <hr>
                                <p class="text-center">Distributed by <a href="https://blogbugabagi.blogpot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></p>
                            </form>
